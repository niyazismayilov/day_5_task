          ...
          children: <Widget>[
            ...
            ElevatedButton(onPressed: (){
              ...
              if( dayOfWeek== 7){
                ...
                answer="Ikinci gun";
              } // Bu shekilde artira bilerik
              setState(() {

              });//Bunu mutleq cagirmaliyiq ki ekran update olsun
            }, child: Text('Yoxla')),
            // 2 ci tapsiriq sonu
            TextField(controller: numberController,),
            ElevatedButton(onPressed: (){
              int number =int.parse(numberController.text.toString());//Istifadeciden aldigimiz qiymet
              if(number%2 ==0) { //Faizli bolme qaliqli bolmeni ifade edir,cut eden 2-ye tam bolunen ededdir.
                answer ="Eded cutdur";
              } else {
                answer="Eded tekdir";
              }
